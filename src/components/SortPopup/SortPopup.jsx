...
const SortPopup = React.memo(
  ({ items = [], activeSortItem, onClickSortItem }) => {
    ...
    const handleOutsideClick = (event) => {
      ...
      return !path.includes(sortRef.current) ? setShowPopup(false) : null;
    };
    ...
    return (
      <div ref={sortRef} className="sort">
        ...
        {showPopup && <div className="sort__popup">{renderMenuItems()}</div>}
      </div>
    );
  }
);
